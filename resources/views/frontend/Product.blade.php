            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                <div class="leftbar p-r-20 p-r-0-sm">
                    <div class="search-product pos-relative bo4 of-hidden">
                        ...
                        <form action="{{ route('searchproduct') }}" method="GET" class="form-inline my-2 my-lg-0">
                           <input class="s-text7 size6 p-l-23 p-r-50" type="text" name="searchproduct" placeholder="Tìm sản phẩm...">
                    ...
                    <ul>
                        ...
                        <li class="p-t-6 p-b-8 bo6">
                            <a href="danh-muc/{{ $item_catego->slug }}" class="s-text13 p-t-5 p-b-5">
                                {{ $item_catego->name }}
                            </a>
                        </li>
                        @endforeach
                    ...
                    <ul>
                        ...
                        <li class="p-t-6 p-b-8 bo6">
                            <a href="thuong-hieu/{{ $item_brand->slug }}" class="s-text13 p-t-5 p-b-5">
                                {{ $item_brand->name }}
                            </a>
                        </li>
                        @endforeach
