  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" action="{{ route('auth.dologin') }}" method="post">
            @csrf
            ...
            <div class="form-group">
              ...
              <input type="email" id="username" name="username" class="form-control form-control-lg" placeholder="Địa chỉ email" required="" autofocus="">
            </div>
            <div class="form-group">
            ...
            <div class="checkbox mb-3">
              <label>
                <input type="checkbox" value="remember-me"> Giữ trạng thái đăng nhập </label>
            </div>
...
<script src="{{ asset('asset-admin/js/apps.js')}}"></script>
